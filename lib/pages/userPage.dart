            ...
            children: [
              ...
              CircleAvatar(
                ...
                child: Container(
                  ...
                  child: Text("Francisco Gómez", style: TextStyle(color: Colors.white, fontSize: 50), textAlign: TextAlign.center,)),
              ),
              SizedBox(height:20),
              Container(
              ...
              SizedBox(height:20), 
              _boton('GUARDAR CAMBIOS', Colors.amber, Colors.white,size,context),                   
            ],
          )
     ),
      ),
